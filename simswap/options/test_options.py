...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--Arc_path", type=str, default='/media/coolboy-3/dys/01-projects/11-MM1-Dual/SimSwap/checkpoints/arcface_checkpoint.tar', help="run ONNX model via TRT")
        self.parser.add_argument("--pic_a_path", type=str, default='/media/coolboy-3/dys/00-dataset/VGGFace2_HQ/vggface2_crop_arcfacealign_224/n000004/0005_01.jpg', help="Person who provides identity information")
        self.parser.add_argument("--pic_b_path", type=str, default='/media/coolboy-3/dys/00-dataset/VGGFace2_HQ/vggface2_crop_arcfacealign_224/n000003/0002_01.jpg', help="Person who provides information other than their identity")
        ...
        self.parser.add_argument("--output_path", type=str, default='/media/coolboy-3/dys/01-projects/11-MM1-Dual/SimSwap/v0/', help="results path")
