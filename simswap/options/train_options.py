...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--load_pretrain', type=str, default='/media/coolboy-3/dys/01-projects/11-MM1-Dual/SimSwap/checkpoints/checkpoints/people/', help='load the pretrained model from the specified location')
