...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/media/coolboy-3/dys/01-projects/11-MM1-Dual/SimSwap/checkpoints/checkpoints', help='models are saved here')
